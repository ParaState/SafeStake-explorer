...
const AppBarComponent = () => {
  ...
  const joinDvfLink = config.links.LINK_DVF_WEBAPP;
              ...
              <Toolbar>
                <Box>
                  <Typography component={'div'} variant="h6" className={classes.title}>
                    <Link href={config.routes.HOME} style={{ color: 'white', textDecoration: 'none' }}>
                      <img style={{ width: 193, height: 35, marginTop: 20 }} src="/images/logo.png" />
                      {/* <span style={{ fontFamily: `"Fira Code", monospace, ${defaultFont}`, whiteSpace: 'nowrap', fontSize: 14 }}>
                        SafeStake.network <b style={{ color: '#DCE0E8' }}>explorer</b>
                      </span> */}
                    </Link>
                  </Typography>
                </Box>
                ...
                <Box style={{ marginLeft: 'auto' }} component="div"
                  ...
                  <div className={classes.toolbarButtons}>
                    {isOverviewPage() ? (
                      <Link href={joinDvfLink} target="_blank">
                        <Button variant="outlined" className={`${classes.appBarButton} ${classes.appBarButtonWhite}`}
                          style={{ textTransform: 'capitalize' }}>Join SafeStake Network</Button>
                      </Link>
                    ) : (
                    ...
                    <Button variant="outlined" disabled
                      ...
                      <GreenDot /> {capitalize(DvfNetwork.getActiveNetwork())} Network
                    </Button>
